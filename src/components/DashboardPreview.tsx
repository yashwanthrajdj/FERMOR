...
export default function DashboardPreview() {
  ...
  return (
    <section className="py-24 bg-[#FAF9F6] border-b border-[#E5E5E5] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm border border-[#E5E5E5] p-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10 pb-6 border-b border-[#E5E5E5]">
            <div>
              <p className="text-sm font-sans font-medium text-[#737373] uppercase tracking-wide mb-1">Total Net Worth</p>
              <h3 className="text-4xl sm:text-5xl font-serif text-[#1A1A1A] tabular-nums tracking-tight">
                {formatCurrency(animatedTotal)}
              </h3>
            </div>
            <div className="mt-4 sm:mt-0 text-right">
              <span className="inline-block bg-[#004D40]/10 text-[#004D40] text-sm font-sans font-medium px-3 py-1 rounded">
                +12.4% this year
              </span>
            </div>
          </div>
              ...
              return (
                <div key={asset.label}>
                  <div className="flex justify-between font-sans mb-2">
                    <span className="text-[#1A1A1A] font-medium">{asset.label}</span>
                    <div className="text-right">
                      <span className="text-[#1A1A1A] tabular-nums font-medium block">{formatCurrency(asset.value)}</span>
                      <span className="text-xs text-[#737373] tabular-nums">{percentage.toFixed(1)}%</span>
                    </div>
                  </div>
